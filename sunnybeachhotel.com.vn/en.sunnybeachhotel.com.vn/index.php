  ...
  <div class="footer">
  	 ...
  	 <div class="container" style="width:980px;">
        ...
        <div class="newsletter_footer">
			...
			<a class="abc">Receive periodic promotional information</a>

			<div class="newssletter">

				<form id="search" action="#" method="post" onsubmit="return sendthongtin(this);" name="frm">

					<input class="input_newssletter" type="text" name="txtEmail" value="Enter your email address" onclick="if (this.value == 'Enter your email address') this.value = '';" style="width:170px; margin-left:1em;"/>
