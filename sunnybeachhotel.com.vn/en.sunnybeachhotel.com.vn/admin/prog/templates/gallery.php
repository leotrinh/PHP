<?
function	template_edit($url,$func,$id,$txt_cat,$txt_ten,$txt_chu_thich,$txt_hinh,$txt_hien_thi,$txt_noi_bat,$txt_link,$error)
{
?>
...
<input type="hidden" name="func" value="<?=$func?>" />
	...
	<tr>
	  ...
	  <td align="left"><input type="text" name="txt_link" value="<?=$txt_link?>" class="inputbox" style="width:90%" /></td>
	  </tr>
	<tr>
		<td align="right">
			Hiển thị :
