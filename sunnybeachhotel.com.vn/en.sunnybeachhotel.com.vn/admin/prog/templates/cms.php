	...
	<tr>
		...
		<?php
			...
			if ( $file[0] != NULL )
			{
				foreach($file as $img)
				{
					echo	'<span style="padding:5px; display:block; float:left"><a href="/uploads/cms_photos/cmslon_'.$img.'" target="_blank"><img src="/uploads/cms_photos/cmsnho_'.$img.'" border="0" style="border:1px #999999 solid;"></a><br><a href="?act=cms_img_del&id='.$id.'&file='.$img.'">delete</a></span>';
				}
			}
...
?>
	...
	<tr>
		...
		<input type="button" value="Xem DS" class="button" style="width:20%;" onclick="history.back()">
		</td>
	</tr>
	</table>
</form>
