...
<div class="left">				
<div class="title_sub" style="font-family:arial; font-size:12px; margin-bottom:2em;"> Restaurants</div>
						...
						<div class="container">
							<div class="content" >
								...
								<?php
                                    ...
                                    $r2	=	$db->select("tgp_page","alias like 'nha_hang'","");
                                    $row2 = $db->fetch($r2);
                                    if ($row2)
                                    {	   
                                 ?>	    
...
<div class="right">
							 <?php include "z_includes/slide_nhahang.php";?>
</div>
