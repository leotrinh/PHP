...
<div class="noidung_sub" style="width:420px;">
	...
	<div class="form_lienhe">
		...
		<div class="rowElem_lh"><label >Full name (*)</label>
		...
		<div class="rowElem_lh"><label>Phone </label>
			
			<input type="text" class="name" value="" name="txtTel" />
		</div>
		
		<div class="rowElem_lh"><label>Address</label>
			<input type="text" class="name" value="" name="txtAddress" />
		</div>
		
		<div class="rowElem_lh"><label>Subject (*)</label>
			<input type="text" class="name" value="" name="txtSubject" />
		</div>
			
		<div class="rowElem_lh" style="height:80px;"><label>Message (*)</label>
