<font size="2" face="Tahoma"><b>Website <img src="images/bl3.gif" border="0" /> Quản lý Website</b></font>
<hr size="1" color="#cadadd" />
<div class="function">
	<a href="?act=doc_new"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=doc_new">Thêm danh sách Website</a>
</div>
<?php
	$delete = $delete + 0;
	if ($delete != 0)
...
?>
  <tr class="tb_content">
    ...
    <td><a href="?act=doc_new&txt_cat=<?=$row2["id"]?>">Thêm Website</a></td>
...
<tr>
	<td colspan="2">
	<div class="function">
		<a href="?act=doc_new"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=doc_new">Thêm danh sách Website</a>	</div>
	</td>
