<font size="2" face="Tahoma"><b>Tin tức</b> <img src="images/bl3.gif" border="0" /> <b class="back" onclick="Forward('?act=cms_manager');">Quản lý tin tức</b><img src="images/bl3.gif" border="0" /> <b>List tin tức</b></font>
...
<table class="tb_table" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    ...
    <td width="5%"><img class="back" onclick="Forward('?act=cms_manager');" src="images/back.png" /></td>
  </tr>
</table>
</center>
<?php
...
<tr class="tb_content">
	<td><?=$count?></td>
	<td><?=$row["hinh"]!="no"?"<img src='../../uploads/cms/cms_".$row['hinh']."' style='width:60px; height:40px;' />":"<img src=\"images/false.gif\" />"?></td>
	<td><?=$row["ten"]?></td>
