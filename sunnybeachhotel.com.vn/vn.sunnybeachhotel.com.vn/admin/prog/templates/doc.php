<?php
function	template_edit($url,$func,$id,$txt_cat,$txt_ten,$txt_chu_thich,$txt_hien_thi,$txt_noi_bat,$error)
{
?>
...
<input type="hidden" name="func" value="<?=$func?>" />
	...
	<tr>
		<td width="35%" align="right">Tên Website: </td>
	...
	<tr>
		<td align="right" valign="top">Link Website :</td>
