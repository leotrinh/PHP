...
<!-- tabs -->
    ...
    <a><img src="/images/icon_tin.png" />&nbsp;&nbsp;TIN TỨC & SỰ KIỆN</a>
    <a><img src="/images/icon_comment.png" /> &nbsp;LỜI KHÁCH HÀNG</a>
    <a><img src="/images/icon_pic.png" /> &nbsp;HÌNH ẢNH KS</a>
    </div>
                        ...
                        ?>						
                            <div class="noidung_gioithieu" id="scoll">
                                ...
                                ?>
                                            <li style="margin-top:2em; margin-left:0.5em; height:110px; float:left; list-style:none;">
                                                ...
                                                <div style="float:left; width:290px; text-align: justify;">
                                                    ...
                                                    <a href="/tin-tuc-xem/<?=$r2["id"]?>" class="next" ><font color="#FFFFCC"> &raquo; &nbsp;Xem tiếp</font></a>
                                                </div>
                                ...
                                ?>
                                    ...
                                    <div style="text-align:center; font-size:15px; color:#000;" >Dữ liệu đang updated...</div>	
                                <?
                                }	
                                ?>	
