...
<div class="left">				
<div class="title_sub" style="font-family:arial; font-size:12px; margin-bottom:2em;"> Tour Bà Nà</div>
						...
						<div class="container">
							<div class="content" >
								...
								<?php
                                    ...
                                    $r2	=	$db->select("tgp_page","alias like 'tour_bana'","");
                                    $row2 = $db->fetch($r2);
                                    if ($row2)
                                    {	   
                                 ?>	    
...
<div class="right">
							 <?php include "z_includes/slide_tourbana.php";?>
</div>
