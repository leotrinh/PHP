...
<div class="rowElem">
	...
	<div style="margin-left:9px; float:left; display:none;">
    	  <input type="text" class="khachsan" onClick="if (this.value == '<?=$row2["ten"]?>') this.value = '<?=$row2["ten"]?>';" value="<?=$row2["ten"]?>" name="txtloaiphong" />
	</div>
	...
	<input name="reset"  class="reset" type="reset"  value=" " />
